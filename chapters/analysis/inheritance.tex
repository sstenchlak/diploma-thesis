...
% jak to ma vypadat v ui, jake jsou moznosti
% jak to ma vypadat v modelu, ze musime udelat ten or a include, ale tady pozor, to koliduje s dalsi kapitolou
% pak jsem uplne zapomnel na popis toho, jak treba pridat koren, nebo jak pridavat properties
