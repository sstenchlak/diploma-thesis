...
\begin{figure}[h!]\centering
  \begin{tikzpicture}
      ...
      \node[universal-schema] (schema1) at (-3.5,-1.5) {Universal schema 1};
      \node (psmDot) at (0,-1.5) {...};
      \node[universal-schema] (schemaN) at (3.5,-1.5) {Universal schema N};
...
There are many different models for data serialization formats with the most known as:
\begin{itemize}
...
% todo pletu schemata a struktury
...
We will allow only classes to be a root of the schemas and instead add an option that the root can be an array. This simplifies the work with the model as we may always expect a class.
...
\begin{figure}[h!]\centering
    \begin{tikzpicture}
        ...
        \node[universal-schema,align=center] (schema1) at (-3,-1.5) {Universal\\schema};
...
\begin{figure}[h!]\centering
  \begin{tikzpicture}
      ...
      \node[universal-schema,align=center] (s11) at (-4.5,-1.5) {Universal\\schema};
      \node[universal-schema,align=center] (s12) at (-1.5,-1.5) {Universal\\schema};
...
\begin{figure}[h!]\centering
    \begin{tikzpicture}
        ...
        \node[universal-schema,align=center] (s11) at (-4.5,-1.5) {Universal\\schema};
        \node[universal-schema,align=center] (s12) at (-1.5,-1.5) {Universal\\schema};
        \node[universal-schema,align=center] (s21) at (3,-1.5) {Universal\\schema};
